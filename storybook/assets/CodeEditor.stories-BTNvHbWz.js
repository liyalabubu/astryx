import{a0 as e,ag as m}from"./iframe-DmzJkFOL.js";import{C as u}from"./CodeEditor-BEC1-TyL.js";import"./preload-helper-Ct5FWWRu.js";import"./highlightRanges-BsHawtAc.js";const x={title:"Lab/CodeEditor",component:u,tags:["autodocs"],argTypes:{language:{control:"select",options:["typescript","javascript","json","html","css","python","bash","php","hack","yaml","markdown","plaintext"]},size:{control:"select",options:["sm","md"]},hasLineNumbers:{control:"boolean"},isReadOnly:{control:"boolean"}}},g=`function greet(name: string): string {
