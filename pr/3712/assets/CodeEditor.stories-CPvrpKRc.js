import{a0 as e,ag as m}from"./iframe-C2vjcrWE.js";import{C as u}from"./CodeEditor-BQm3v1e8.js";import"./preload-helper-Ct5FWWRu.js";import"./highlightRanges-BziULa9W.js";const x={title:"Lab/CodeEditor",component:u,tags:["autodocs"],argTypes:{language:{control:"select",options:["typescript","javascript","json","html","css","python","bash","php","hack","yaml","markdown","plaintext"]},size:{control:"select",options:["sm","md"]},hasLineNumbers:{control:"boolean"},isReadOnly:{control:"boolean"}}},g=`function greet(name: string): string {
