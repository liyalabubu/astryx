import{a0 as e,ag as m}from"./iframe-sWQnFfOz.js";import{C as u}from"./CodeEditor-COGGoRu1.js";import"./preload-helper-Ct5FWWRu.js";import"./highlightRanges-VtjW0nnQ.js";const x={title:"Lab/CodeEditor",component:u,tags:["autodocs"],argTypes:{language:{control:"select",options:["typescript","javascript","json","html","css","python","bash","php","hack","yaml","markdown","plaintext"]},size:{control:"select",options:["sm","md"]},hasLineNumbers:{control:"boolean"},isReadOnly:{control:"boolean"}}},g=`function greet(name: string): string {
