import{a0 as e,ag as m}from"./iframe-rkt6EJ0_.js";import{C as u}from"./CodeEditor-BH186HT_.js";import"./preload-helper-Ct5FWWRu.js";import"./highlightRanges-D_7RPx8L.js";const x={title:"Lab/CodeEditor",component:u,tags:["autodocs"],argTypes:{language:{control:"select",options:["typescript","javascript","json","html","css","python","bash","php","hack","yaml","markdown","plaintext"]},size:{control:"select",options:["sm","md"]},hasLineNumbers:{control:"boolean"},isReadOnly:{control:"boolean"}}},g=`function greet(name: string): string {
